...
public class SendMail {
	...
	public static void sendTemplate(String title,String mailbody){
		...
		//发送到哪里
		if(themail.setTo(acceptMailAccount) == false) return;
		
		//谁发送的
		if(themail.setFrom(sendAccount) == false) return;
...
//		themail.setNamePass("sunhongsb",passwd);
		themail.setNamePass(sendAccount, sendMailPassword);
